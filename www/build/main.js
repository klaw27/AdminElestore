...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__register_register__ = __webpack_require__(359);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__models_model__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__recuperarcuenta_recuperarcuenta__ = __webpack_require__(360);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ionic_native_camera__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_geolocation__ = __webpack_require__(92);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__inicio_inicio__ = __webpack_require__(55);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PedidosNoEntregadosPage = /** @class */ (function () {
    function PedidosNoEntregadosPage(navCtrl, navParams, afdb, storage) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.afdb = afdb;
        this.storage = storage;
                    ...
                    case 0: return [4 /*yield*/, this.storage.get("setting:" + settingName).then(function (value) {
                            ...
                            _this.afdb.list("pedidos/" + ("" + _this.pedidos.negocio[0].id_negocio)).snapshotChanges().subscribe(function (data) {
                                data.map(function (data) {
                                    ...
                                    _this.objPedidosNoEntregados = info;
                                });
                            });
                        })];
                    case 1: return [2 /*return*/, _a.sent()];
    ...
    PedidosNoEntregadosPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-pedidos-no-entregados',template:/*ion-inline-start:"C:\Users\kym\Documents\ELESTOR\app-admin\el.estor.mobile-app\src\pages\pedidos-no-entregados\pedidos-no-entregados.html"*/'<ion-content padding>\n\n  <ion-item-divider>\n\n    <ion-list>\n\n      <ion-item>\n\n          <label style="text-align: center">\n\n            Pedidos no entregados\n\n          </label>\n\n      </ion-item>\n\n      <ion-item>\n\n        \n\n      </ion-item>\n\n    </ion-list>\n\n  </ion-item-divider>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\kym\Documents\ELESTOR\app-admin\el.estor.mobile-app\src\pages\pedidos-no-entregados\pedidos-no-entregados.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_common_http__ = __webpack_require__(358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__negocio_detalle_negocio_detalle__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pedidos_no_entregados_pedidos_no_entregados__ = __webpack_require__(250);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pedidos_entregados_pedidos_entregados__ = __webpack_require__(362);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_model__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pedidos_todos_pedidos_todos__ = __webpack_require__(363);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_storage__ = __webpack_require__(35);
...
var PedidosPage = /** @class */ (function () {
    ...
    PedidosPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["n" /* Component */])({
            selector: 'page-pedidos',template:/*ion-inline-start:"C:\Users\kym\Documents\ELESTOR\app-admin\el.estor.mobile-app\src\pages\pedidos\pedidos.html"*/'<ion-header>\n\n    <ion-title style="text-align: center">\n\n      Listado de pedidos : {{userModel.nombreUsuario}}\n\n    </ion-title>\n\n</ion-header>\n\n\n\n<ion-tabs>\n\n  <ion-tab title="Todos" [root]="pedidosTodos" tabIcon="podium">\n\n\n\n  </ion-tab>\n\n  <ion-tab title="Entregados" [root]="pedidosEntregados" tabIcon="podium">\n\n\n\n  </ion-tab>\n\n  <ion-tab title="No Entregados" [root]="pedidosNoEntregados" tabIcon="podium"> \n\n\n\n  </ion-tab>\n\n</ion-tabs>\n\n<ion-fab left bottom (click)="back()">\n\n  <button ion-fab ><ion-icon class="more" name="arrow-round-back"></ion-icon></button>\n\n</ion-fab> \n\n'/*ion-inline-end:"C:\Users\kym\Documents\ELESTOR\app-admin\el.estor.mobile-app\src\pages\pedidos\pedidos.html"*/,
        }),
...
var PedidosEntregadosPage = /** @class */ (function () {
    function PedidosEntregadosPage(navCtrl, navParams, afdb, storage) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.afdb = afdb;
        this.storage = storage;
...
var PedidosTodosPage = /** @class */ (function () {
    function PedidosTodosPage(navCtrl, navParams, api, afdb, storage) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.api = api;
        this.afdb = afdb;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storage.get("setting:" + settingName).then(function (value) {
                            _this.pedidos = value;
                            _this.afdb.list("pedidos/" + ("" + _this.pedidos.clientid)).snapshotChanges().subscribe(function (data) {
                                data.map(function (data) {
                                    var info = data.payload.val();
                                    _this.objPedidosTodos = info;
                                    debugger;
    ...
    PedidosTodosPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-pedidos-todos',template:/*ion-inline-start:"C:\Users\kym\Documents\ELESTOR\app-admin\el.estor.mobile-app\src\pages\pedidos-todos\pedidos-todos.html"*/'<ion-content padding>\n\n    <ion-item-divider>\n\n        <ion-list>\n\n          <ion-item>\n\n              <label style="text-align: center">\n\n                Listados de Pedidos en el Sistema\n\n              </label>\n\n          </ion-item>\n\n              <ion-item-sliding *ngFor="let pedido of objPedidosEntregados " class="contNeg">\n\n            <ion-item>\n\n              <ion-thumbnail item-start class="logoProd">\n\n                <img  onError="this.src=\'/assets/imgs/producto.png\'" class="logimg">\n\n              </ion-thumbnail>\n\n              <h2 class="nombreNeg">{{pedido.nombreNeg}}</h2>\n\n              <div class="contenedorEstrellas">\n\n                  <ion-icon class="estrella" name=\'star\'></ion-icon>\n\n                  <ion-icon class="estrella" name=\'star\'></ion-icon>\n\n                  <ion-icon class="estrella" name=\'star\'></ion-icon>\n\n                  <ion-icon class="estrella" name=\'star\'></ion-icon>\n\n                  <ion-icon class="estrella" name=\'star\'></ion-icon>\n\n                </div>\n\n            </ion-item>\n\n              <ion-item-options>\n\n                <button ion-button color="danger" (click)="borrarProducto(prod)" > Borrar</button>\n\n                <button ion-button color="gray" (click)="editarProducto(prod)" > Editar</button>\n\n            </ion-item-options>\n\n          </ion-item-sliding>\n\n        </ion-list>\n\n        \n\n      </ion-item-divider>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\kym\Documents\ELESTOR\app-admin\el.estor.mobile-app\src\pages\pedidos-todos\pedidos-todos.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_platform_browser__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__angular_common__ = __webpack_require__(49);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NegocioEditarProductoPage = /** @class */ (function () {
    ...
    NegocioEditarProductoPage.prototype.back = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_6__negocio_detalle_negocio_detalle__["a" /* NegocioDetallePage */], { item: this.userModel });
    };
    NegocioEditarProductoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-negocio-editar-producto',template:/*ion-inline-start:"C:\Users\kym\Documents\ELESTOR\app-admin\el.estor.mobile-app\src\pages\negocio-editar-producto\negocio-editar-producto.html"*/'<ion-header>\n\n    <ion-title style="text-align: center">\n\n      Editar Producto\n\n    </ion-title>\n\n</ion-header>\n\n\n\n<ion-content >\n\n      <img src="/assets/imgs/ElEstorLogoCuadroyAza.png" alt="" class="center">\n\n  \n\n  <h3>Datos del producto</h3>\n\n\n\n            <form [formGroup]="formGroup">\n\n                \n\n                <div class="producto">\n\n                    <img class="imgPro" [src]="fotografia" onError="this.src=\'/assets/imgs/producto.png\'">\n\n                    <button color="light" class="camara" ion-button icon-only (click)="presentActionSheet()">\n\n                        <ion-icon class="icono" name="camera"></ion-icon>\n\n                    </button>\n\n                </div>\n\n              <ion-list>\n\n              <ion-item class="campo">\n\n                  <ion-input class="entrada" placeholder="Nombre del Platillo" [disabled]="editar" type="text" [(ngModel)]="producto.nombre" formControlName="platillo" ></ion-input>\n\n                </ion-item>\n\n                <ion-item *ngIf="platillo.hasError(\'required\') && platillo.touched">\n\n                  <p style="color:red">\n\n              *Falta Nombre del platillo\n\n                  </p>\n\n                  </ion-item>\n\n                  <ion-item class="campo"> \n\n                      <ion-input class="entrada" placeholder="Precio" [disabled]="editar"  type="number" [(ngModel)]="producto.precio" formControlName="precio">\n\n                         \n\n                      </ion-input>\n\n                    </ion-item>\n\n                    <ion-item *ngIf="precio.hasError(\'required\') && precio.touched">\n\n                      <p style="color:red">\n\n                *Falta Precio\n\n                    </p>\n\n                    </ion-item>\n\n                    <ion-item class="campo">\n\n                        <ion-input class="entrada" placeholder="Descripción" [disabled]="editar" type="text" [(ngModel)]="producto.descripcion" formControlName="descripcion"></ion-input>\n\n                      </ion-item>\n\n                      <ion-item *ngIf="descripcion.hasError(\'required\') && descripcion.touched">\n\n                        <p style="color:red">\n\n                    *Falta Descripcion\n\n                        </p>\n\n                        </ion-item>\n\n                        <ion-item class="campo">\n\n                        <ion-input class="entrada" placeholder="Complementos" [disabled]="editar" type="text" [(ngModel)]="producto.complemento" formControlName="complemento"></ion-input>\n\n                      </ion-item>\n\n                        <ion-item class="campo"> \n\n                        <ion-input class="entrada" placeholder="Tiempo de preparacion" [disabled]="editar" type="number"  [(ngModel)]="producto.tiempopreparacion" formControlName="tiempopreparacion"></ion-input>\n\n                      </ion-item>\n\n                      <ion-item *ngIf="tiempopreparacion.hasError(\'required\') && tiempopreparacion.touched">\n\n                      <p style="color:red">\n\n                  *Falta Tiempo de Preparacion\n\n                      </p>\n\n                      </ion-item>\n\n                      <ion-item class="campo">\n\n                        <ion-label>\n\n                          Categoria del Producto\n\n                        </ion-label>\n\n                        <ion-select [(ngModel)]="producto.id_catProducto " formControlName="catproducto" placeholder="Selecciona una Categoria">\n\n                            <ion-option value="{{cat.id_catProducto}}"  *ngFor="let cat of catProd">{{cat.nombre}}</ion-option>\n\n                          </ion-select>\n\n                      </ion-item>\n\n                      <ion-item class="campo">\n\n                        <ion-label>\n\n                          Otra Categoria\n\n                        </ion-label>\n\n                        <ion-input class="entrada" placeholder="Otra Categoria" [disabled]="editar" type="text"  [(ngModel)]="producto.otracategoria" formControlName="otracategoria"></ion-input>\n\n                      </ion-item>\n\n                         <ion-item *ngIf="otracategoria.hasError(\'required\') && otracategoria.touched">\n\n                      <p style="color:red">\n\n                      *Falta Otra Categoria\n\n                      </p>\n\n                      </ion-item>\n\n            </ion-list>\n\n          </form>\n\n\n\n        <ion-grid>\n\n  \n\n        <ion-row>\n\n              <!-- <ion-fab bottom right>\n\n        <button ion-fab (click)="agregarProducto($event)">+</button>\n\n    </ion-fab> -->\n\n    <!-- <ion-fab vertical="top" horizontal="end" slot="fixed">\n\n        <ion-fab-button>\n\n          <ion-icon name="add"></ion-icon>\n\n        </ion-fab-button>\n\n      </ion-fab> -->\n\n<!-- <button ion-button full color="light" (click)="agregarProducto($event)" >\n\n    Agregar Producto\n\n  </button> -->\n\n            <!-- [disabledd]="formGroup.invalid"\n\n        <button [disabled]="editar" type="submit"  ion-button full color="light" (click)="guardarNegocio($event, negocio)" >\n\n          Guardar  Negocio\n\n        </button> -->\n\n            <!-- <button [disabled]="formGroup.invalid" type="submit" ion-button full color="light" (click)="agregarProducto(producto,$event)" > -->\n\n                <button  type="submit" ion-button full color="light" (click)="agregarProducto(producto,$event)" >\n\n              Guardar Producto\n\n            </button>\n\n        </ion-row>\n\n      </ion-grid>\n\n\n\n      <ion-fab left bottom (click)="back()">\n\n        <button ion-fab ><ion-icon class="more" name="arrow-round-back"></ion-icon></button>\n\n      </ion-fab> \n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\kym\Documents\ELESTOR\app-admin\el.estor.mobile-app\src\pages\negocio-editar-producto\negocio-editar-producto.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_pedidos_no_entregados_pedidos_no_entregados__ = __webpack_require__(250);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_negocio_detalle_editar_negocio_detalle_editar__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_map_map__ = __webpack_require__(365);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_negocio_agregar_producto_negocio_agregar_producto__ = __webpack_require__(366);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_negocio_detalle_negocio_detalle__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_nuevonegocio_nuevonegocio__ = __webpack_require__(208);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_negocios_negocios__ = __webpack_require__(649);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_inicio_inicio__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__angular_common_http__ = __webpack_require__(358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__angular_platform_browser__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_native_status_bar__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__agm_core__ = __webpack_require__(650);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__app_component__ = __webpack_require__(655);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_register_register__ = __webpack_require__(359);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_recuperarcuenta_recuperarcuenta__ = __webpack_require__(360);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__providers_elstorapi_elstorapi__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__shared_password_validator__ = __webpack_require__(656);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_perfil_perfil__ = __webpack_require__(364);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_pedidos_pedidos__ = __webpack_require__(361);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_pedidos_todos_pedidos_todos__ = __webpack_require__(363);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_pedidos_entregados_pedidos_entregados__ = __webpack_require__(362);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__pages_modal_pedido_modal_pedido__ = __webpack_require__(657);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__angular_fire__ = __webpack_require__(338);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__angular_fire_database__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__config__ = __webpack_require__(658);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__ionic_storage__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pages_negocio_editar_producto_negocio_editar_producto__ = __webpack_require__(367);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_model__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pedidos_pedidos__ = __webpack_require__(361);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_storage__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__negocio_detalle_negocio_detalle__ = __webpack_require__(61);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__negocio_detalle_editar_negocio_detalle_editar__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__map_map__ = __webpack_require__(365);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_model__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__negocio_agregar_producto_negocio_agregar_producto__ = __webpack_require__(366);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__negocio_editar_producto_negocio_editar_producto__ = __webpack_require__(367);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
>>>>>>> 6fe4941157dac12694132174bf32296c906b8863
        }),
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"C:\Users\kym\Documents\ELESTOR\app-admin\el.estor.mobile-app\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n\n'/*ion-inline-end:"C:\Users\kym\Documents\ELESTOR\app-admin\el.estor.mobile-app\src\app\app.html"*/
        }),
